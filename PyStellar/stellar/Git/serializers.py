...
class GitCommitCheckSerializer(serializers.Serializer):
    ...
    since = serializers.CharField(max_length=17, help_text='Since', allow_null=True, default='')
    until = serializers.CharField(max_length=17, help_text='Until', allow_null=True, default='')
